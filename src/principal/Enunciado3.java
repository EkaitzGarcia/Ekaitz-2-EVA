...
public class Enunciado3 {
	...
	public static void main(String[] args) {
		...
		inventario[2] = new Producto ("Pera", 1.23, 30);
		inventario[3] = new Producto ("Manzana", 1.50, 2);
		inventario[4] = new Producto ();
		inventario[5] = new Producto ("Naranja", 0.23, 42);
		double total = 0;
		...
		//Mover lo null al final del array.
		for(int l = 0; l < inventario.length -1; l++) {
			for(int n = 0; n < inventario.length - l - 1; n++) {
				if(inventario[l] == null && inventario[n] != null) {
					int aux2 = inventario[n];
